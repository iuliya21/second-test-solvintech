    ...
    <div className={`${wrapper} relative z-20`}>
      <form className={`flex flex-col ${container} `}>
        <div className="flex flex-col gap-6">
          <input type="text" className="p-[10px] rounded-lg leading-[1.2] shadow"
            placeholder="Имя" />
          <div className="flex justify-between max-sm:flex-col max-sm:gap-y-6">
            <div className="flex p-[10px] shadow gap-x-[10px] rounded-lg items-center">
              ...
              <div className="bg-colorGreen rounded-lg px-3 py-[6px] flex gap-x-2 items-center">
                <img src={require("../images/calendar-month.svg").default} alt="Календарь" className="w-3 h-[14px]" />
                <p className="text-colorWhite leading-none text-xs font-bold ">10.11.2004</p>
              </div>
            </div>
            <div className="max-w-[135px] flex items-center justify-center gap-x-2 p-[10px] shadow rounded-lg">
              ...
              <div className="flex gap-x-2">
                ...
                <div className="bg-colorGreen w-6 h-6 flex py-1 justify-center rounded-lg">
                  <img src={require("../images/girl.svg").default} alt="Девочка" />
                </div>
              </div>
            </div>
          </div>
